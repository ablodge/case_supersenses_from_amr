...
train_output = "C:\\Users\\Austin\\Desktop\\Project\\amr_and_ngrams"+str(D)+"."+str(N)+"-train.mff"
test_output = "C:\\Users\\Austin\\Desktop\\Project\\amr_and_ngrams"+str(D)+"."+str(N)+"-test.mff"
